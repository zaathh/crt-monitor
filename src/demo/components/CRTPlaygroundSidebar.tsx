...
export const PRESET_OPTIONS: { id: PresetName; label: string }[] = [
  { id: 'ARCADE', label: 'ARCADE' },
  { id: 'RETRO TV', label: 'RETRO TV' },
  { id: 'BROADCAST PVM', label: 'PVM PRO' },
  { id: 'VHS TAPE', label: 'VHS TAPE' },
  { id: 'COMMODORE', label: 'C-64' },
  { id: 'TERMINAL', label: 'TERMINAL' },
  { id: 'AMBER CRT', label: 'AMBER' },
  { id: 'CYBERPUNK', label: 'CYBERPUNK' },
  { id: 'MILD', label: 'MILD' },
];

interface CRTPlaygroundSidebarProps {
...
export const CRTPlaygroundSidebar: React.FC<CRTPlaygroundSidebarProps> = ({
  settings,
  onSettingsChange,
  activePreset,
  onSelectPreset,
  ...
  return (
    <div className="playground-sidebar">
      ...
      <div className="sidebar-header">
        <span className="header-brand-text">CRT PARAMETERS</span>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <button className="btn-reset-preset" onClick={onReset} title="Reset all to Preset Defaults">
            <svg
              width="12"
              height="12"
              viewBox="0 0 24 24"
      ...
      <div className="sidebar-presets-wrap">
